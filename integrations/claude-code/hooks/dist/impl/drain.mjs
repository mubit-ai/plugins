...
function cachePath2(cfg, runId) {
  ...
  return join9(runDir(isObject5(cfg) ? cfg : {}, runId), CACHE_FILE3);
}
...
import { existsSync as existsSync5, readdirSync as readdirSync2, readFileSync as readFileSync5, statSync as statSync5 } from "node:fs";
import { basename as basename2, dirname as dirname5, join as join10, resolve as resolve3 } from "node:path";
