...
function scanRunMarkers(root) {
  const out = [];
  try {
    const dir = join6(str5(root), "status");
    if (!str5(root) || !existsSync4(dir)) return out;
...
// bin/handoff.src.mjs
var USAGE = `mubit-memory: hand work to another agent, list what is open, or answer a handoff.
