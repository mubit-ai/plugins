...
var RULES_FILE, MAX_RULES, MAX_TEXT, MAX_REF;
...
// ../claude-code/hooks/src/pre-tool.mjs
var pre_tool_exports = {};
...
var BUDGET_MS, SUPPRESS, MAX_SURFACED, MIN_OVERLAP, TERM_RE, STOPWORDS, MAX_INPUT_SCAN, MAX_DEPTH;
var init_pre_tool = __esm({
  async "../claude-code/hooks/src/pre-tool.mjs"() {
    init_config();
    init_hook();
    init_log();
    init_rules();
...
await init_pre_tool().then(() => pre_tool_exports);
