...
var ENTRY_TYPES, RANK_MODES, RESUME_SECTIONS, RESUME_ENTRY_TYPES, RESUME_QUERY, RESUME_LIMIT, RESUME_TIMEOUT_MS, RESUME_TOKEN_BUDGET;
var init_recall = __esm({
  "../claude-code/lib/recall.mjs"() {
    ...
    RESUME_QUERY = "Where did the work on this project leave off; what was in progress or blocked when it stopped; what should the next session pick up first.";
    RESUME_LIMIT = 12;
    RESUME_TIMEOUT_MS = 2e4;
    RESUME_TOKEN_BUDGET = 1e3;
  }
});
...
function resumePath(cfg, runId) {
  ...
  return join7(runDir(cfg, runId), "resume.json");
}
...
// ../claude-code/hooks/src/session-resume.mjs
var session_resume_exports = {};
...
var HARNESS_BUDGET_MS, MAX_ID, SUPPRESS;
var init_session_resume = __esm({
  async "../claude-code/hooks/src/session-resume.mjs"() {
    init_config();
    init_hook();
    init_log();
    init_recall();
    init_resume();
    HARNESS_BUDGET_MS = 22e3;
    MAX_ID = 128;
...
await init_session_resume().then(() => session_resume_exports);
