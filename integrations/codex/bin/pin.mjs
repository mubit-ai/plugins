...
function pickRun(cfg, explicit = "") {
  ...
  return {
    ok: false,
    state: "no_run",
    detail: 'Could not tell which Mubit run this session is using \u2014 no hook has written a run marker yet. Send one prompt first, or name the run: pin --run <run_id> "\u2026". /mubit-memory:doctor prints the current run id.'
  };
}
