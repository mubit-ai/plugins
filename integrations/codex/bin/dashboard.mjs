...
import { realpathSync as __mubitRealpath, existsSync as __mubitExists, readFileSync as __mubitRead, readdirSync as __mubitReaddir, statSync as __mubitStat } from "node:fs";
...
var entryPath = process.argv[1] ? __mubitRealPath(resolve2(process.argv[1])) : "";
